...
import com.roaa.treading.enums.OrderStatus;
import com.roaa.treading.enums.OrderType;
import com.roaa.treading.repository.AssetRepository;
import com.roaa.treading.repository.OrderItemRepository;
import com.roaa.treading.repository.OrderRepository;
...
public class OrderServiceImpl implements OrderService{
    ...
    public Order sellAsset(Coin coin, double quantity, User user) throws Exception {
        ...
        if(assetToSell != null){
            ...
            throw new Exception("Insufficient Quantities to sell");
        }
