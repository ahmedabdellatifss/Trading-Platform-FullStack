...
public class CoinServiceImpl implements CoinService {
    ...
    public List<Coin> getCoinList(int page) throws Exception {
        String url = "http://api.coingecko.com/api/v3/coins/markets?vs_currency=usd&per_page=10&page="+page;
    ...
    public String getMarketChart(String coinId, int days) throws Exception {
        String url = "http://api.coingecko.com/api/v3/coins/"+coinId+"/market_chart?vs_currency=usd&days="+days;
        RestTemplate restTemplate = new RestTemplate();
        try {
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<String> entity = new HttpEntity<>("parameters",headers);
    ...
    public String getCoinDetail(String coinId) throws Exception {
        String url = "http://api.coingecko.com/api/v3/coins/"+coinId;
        RestTemplate restTemplate = new RestTemplate();
        try {
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<String> entity = new HttpEntity<>("parameters",headers);
    ...
    public String searchCoin(String keyword) throws Exception {
        String url = "http://api.coingecko.com/api/v3/search?query="+keyword;
        RestTemplate restTemplate = new RestTemplate();
        try {
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<String> entity = new HttpEntity<>("parameters",headers);
    ...
    public String getTo50CoinByMarketCapRank() throws Exception {
        String url = "http://api.coingecko.com/api/v3/coins/markets/vs_currency=usd&per_page=50&page=1";
        RestTemplate restTemplate = new RestTemplate();
        try {
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<String> entity = new HttpEntity<>("parameters",headers);
    ...
    public String getTreadingCoins() throws Exception {
        String url = "http://api.coingecko.com/api/v3/search/treading";
        RestTemplate restTemplate = new RestTemplate();
        try {
            HttpHeaders headers = new HttpHeaders();
            HttpEntity<String> entity = new HttpEntity<>("parameters",headers);
